...
white.addEventListener('click', () => {
  console.log("hallo");
  mainImg.src = "../shirts/hoodie/front_large_extended (2).jpg";
...
black.addEventListener('click', () => {
  mainImg.src = "../shirts/hoodie/front_large_extended.jpg";
...
red.addEventListener('click', () => {
  mainImg.src = "../shirts/hoodie/front_large_extended (1).jpg";
  color.innerHTML = "Red";
  white.style.borderColor = "#737373";
  black.style.borderColor = "#737373";
...
blue.addEventListener('click', () => {
  mainImg.src = "../shirts/hoodie/front_large_extended (4).jpg";
