...
white.addEventListener('click', () => {
  console.log("hallo");
  mainImg.src = "../shirts/long_sleeve/front_large_extended.jpg";
...
black.addEventListener('click', () => {
  mainImg.src = "../shirts/long_sleeve/front_large_extended (1).jpg";
...
red.addEventListener('click', () => {
  mainImg.src = "../shirts/long_sleeve/front_large_extended (2).jpg";
  color.innerHTML = "Red";
  white.style.borderColor = "#737373";
  black.style.borderColor = "#737373";
...
blue.addEventListener('click', () => {
  mainImg.src = "../shirts/long_sleeve/front_large_extended (3).jpg";
